...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_URL = "https://api.twitter.com/1.1"; // Change
																			...
																			// API
																			// URL
	public static final String REST_CONSUMER_KEY = "oTWoGSJMhxQFuF72hNupyXPdp"; // Change
																				// this
	public static final String REST_CONSUMER_SECRET = "tLEavPABMItOyzwd6UiKYbkKwqUj1EGeXxyPHZt548XmWdARul"; // Change
																											// this
	...
	public void GetUserTimeline(long maxId, long sinceId, String screenname,
			JsonHttpResponseHandler handler) {
		GetGenericTimeline("user", maxId, sinceId, screenname, handler);
	}

	private void GetGenericTimeline(String timelineName, long maxId,
			long sinceId, String screenname, JsonHttpResponseHandler handler) {
		if (isNetworkAvailable()) {
			String apiUrl = getApiUrl("statuses/" + timelineName
					+ "_timeline.json");
			RequestParams params = new RequestParams();
			if (sinceId != 0) {
